<template>
<h2>Single image verifier (with upload)</h2>
    <p>
        <input
            type="file" 
...
export default {
    ...
    methods: {
        async fetchData(evt) {
            ...
            const stringAPI = 'fr/verify/with_upload?detector_name=retinaface&verifier_name=ArcFace&align=true&normalization=base&metric=cosine&threshold=-1&verbose=false'
